...

  {
    ...
    children: [
      // 用户组织管理
      {
        ...
        redirect: '/form/base-form',
        component: PageView,
        meta: { title: '用户组织管理', icon: 'form', permission: ['form'] },
        children: [
          {
            path: '/form/base-form',
            name: 'BaseForm',
      ...
      // list 角色权限管理
      {
        ...
        meta: { title: '角色权限管理', icon: 'table', permission: ['table'] },
        children: [
          {
            ...
            meta: { title: '查询表格-应用', keepAlive: true, permission: ['table'] }
          },
          {
      ...
      // profile 安全管理
      {
        ...
        meta: { title: '安全管理', icon: 'safety-certificate', permission: ['profile'] },
        children: [
          {
            path: '/profile/basic',
            name: 'ProfileBasic',
